...
class TestGetOrder(object):
    ...
    def test_can_get_order(self, gateway_service, web_session):
        ...
        gateway_service.products_rpc.products_by_ids.return_value = [
            {
                'id': 'the_odyssey',
                'title': 'The Odyssey',
                'maximum_speed': 3,
        ...
        assert [call(['the_odyssey', 'the_enigma'])
                ] == gateway_service.products_rpc.products_by_ids.call_args_list
...
class TestCreateOrder(object):
    ...
    def test_can_create_order(self, gateway_service, web_session):
        ...
        assert gateway_service.products_rpc.products_by_ids.call_args_list == [
            call(['the_odyssey'])]
